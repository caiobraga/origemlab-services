 ...
 * Uso: node scripts/fix-bad-titles.mjs [--dry-run]
 */
...
import {
  ...
  isWeakLinkTitle,
  stripLinkPrefix,
} from "../src/scraperTitleUtils.mjs";
...
async function main() {
  ...
  for (const e of data || []) {
    ...
    if (next && next !== e.titulo) fixes.push({ id: e.id, fonte: e.fonte, from: e.titulo, to: next, numero: e.numero });
  }
