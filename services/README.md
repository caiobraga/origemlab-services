...
| [ollama-service](./ollama-service/README.md) | **Infra:** Ollama ECS Fargate + NLB (endpoint estável) | `deploy-ollama-service.yml`, `infrastructure/ecs-ollama-service.yml` |
| [ollama-server](./ollama-server/README.md) | **Legado:** EC2 + Elastic IP | `deploy-ollama-server.yml` (manual) |

**Produção:** `OLLAMA_BASE_URL=http://origemlab-ollama-nlb-312422980eebe2d0.elb.us-east-1.amazonaws.com:11434` (GitHub Variables).
